...
<?php 
  ...
  if(@$_POST["mesaj_gonder"]) {
    $ad = $_POST['ad'];
    $soyad = $_POST['soyad'];
    $eposta = $_POST['eposta'];
    $mesaj = $_POST['mesaj'];

    if(!empty($ad) && !empty($soyad) && !empty($eposta) && !empty($mesaj)) {
      $sorgu = "INSERT INTO mesajlar(ad, soyad, eposta, mesaj) VALUES('{$ad}', '{$soyad}', '{$eposta}', '{$mesaj}')";
      $sonuc = mysqli_query($baglanti, $sorgu);
      if($sonuc == 1) {
        header("Refresh: 0");
      }
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-lg-5 ml-auto section-title">
            <span class="sub-title mb-2 d-block">TANITIM</span>
      ...
      <div class="container">
        ...
        <div class="row mb-5 ">
          <div class="col-md-7 section-title text-center mx-auto">
            <span class="sub-title mb-2 d-block">Fotoğraflar</span>
        ...
        <div class="row">
          <?php  foreach ($galeri as $g)  { ?>
              <div class="item design col-md-4">
                <a href="yonetici/img/galeri/<?php echo $g['id']; ?>.jpg" class="item-wrap" data-fancybox="gal">
                  <span class="icon-search2"></span>
                  <img class="img-fluid" src="yonetici/img/galeri/<?php echo $g['id']; ?>.jpg" style="height:400px;">
                </a>
              </div>
          <?php } ?>
        </div>
    ...
    <div class="site-section" id="contact-section">
      <div class="container">
        <form method="post" enctype="multipart/form-data" class="contact-form">
          ...
          <div class="row mb-4">
            <div class="col-12">
              <input type="text" name="eposta" class="form-control" placeholder="Eposta">
            </div>
          </div>

          <div class="row mb-4">
            <div class="col-12">
              <textarea class="form-control" name="mesaj" cols="30" rows="10" placeholder="Mesaj"></textarea>
            </div>
          </div>

          <div class="row">
            <div class="col-12">
              <button name="mesaj_gonder" value="1" class="btn btn-primary btn-md">Mesajı Gönder</button>
            </div>
          </div>
